    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('stock', models.DecimalField(decimal_places=2, default=0.0, max_digits=5, verbose_name='Existencias')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('units', models.DecimalField(decimal_places=2, default=0.0, max_digits=5, verbose_name='Cantidad')),
                ...
                ('working_day', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='resources', to='apis_.workingday', verbose_name='Jornada laboral')),
            ],
            options={
